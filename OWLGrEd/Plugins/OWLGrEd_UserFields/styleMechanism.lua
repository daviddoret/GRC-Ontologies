...
function selectElementType()
	...
	if eType:is_not_empty() then
		...
		local viewStyleSetting = lQuery.create("AA#ViewStyleSetting", {elementTypeName=elemTypeValue, isElementStyleSetting=true}):link("view", lQuery("AA#View[name='" .. viewName .. "']"))
