							...
							,lQuery.create("D#VerticalBox", {
								component = {
									lQuery.create("D#ImageButton",{
										fileName = tda.GetProjectPath() .. "\\Plugins\\OWLGrEd_UserFields\\up.BMP"
										,eventHandler = utilities.d_handler("Click", "lua_engine", "lua.OWLGrEd_UserFields.viewMechanism.upView()")
									})
									,lQuery.create("D#ImageButton",{
										fileName = tda.GetProjectPath() .. "\\Plugins\\OWLGrEd_UserFields\\down.BMP"
...
function setShowInPalette()
	...
	if focus == "true" then 
		...
		lQuery.create("D#Row", {id = view:id(),component={
			...
			,lQuery.create("D#ImageButton", {fileName = tda.GetProjectPath() .. "\\Pictures\\" .. view:attr("inActiveIcon")})
			...
			lQuery.create("D#VerticalBox", {
				...
				,component = {
					lQuery.create("D#Row", {
						horizontalAlignment = -1
						,component = {
							lQuery.create("D#Label", {caption = 'Is default view'})
							,lQuery.create("D#CheckBox", {
								id = "setViewDefault"
					...
					,lQuery.create("D#Row", {
						...
						,component = {
							...
							,lQuery.create("D#ImageButton", {
								id = "activeIcon"
								,fileName = tda.GetProjectPath() .. "\\Pictures\\" .. view:attr("activeIcon")
							...
							,lQuery.create("D#ImageButton", {
								id = "inactiveIcon"
								,fileName = tda.GetProjectPath() .. "\\Pictures\\" .. view:attr("inActiveIcon")
